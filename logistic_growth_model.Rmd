...
ggplot()+ 
  ...
  labs(y = "Daily new incident cases", title ="Germany", subtitle = "Daily new cases and model") +
  xlim(c(as.Date('2020-02-15 00:00:00', format = "%Y-%m-%d %H:%M:%S"),
         as.Date('2020-05-20 00:00:00', format = "%Y-%m-%d %H:%M:%S")))+
...
ggplot()+ 
  ...
  labs(y = "Daily new incident cases", title ="Switzerland", subtitle = "Daily new cases and model") +
  xlim(c(as.Date('2020-02-15 00:00:00', format = "%Y-%m-%d %H:%M:%S"),
         as.Date('2020-05-20 00:00:00', format = "%Y-%m-%d %H:%M:%S")))+
  scale_color_manual(values = c("Incident Cases"="blue", "Gompertz-function"="red"))+
  theme(legend.position = "top", legend.title = element_blank())
