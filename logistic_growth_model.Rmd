...
<<<<<<< HEAD
title<-paste(country, dateDownloaded)
subtitle<-"Daily new cases and model, conditions - quarantine "
ggplot()+ 
  ...
  labs(y = "Daily new incident cases", title =title, subtitle = subtitle) +
=======
title=paste(country, dateDownloaded)
ggplot()+ 
  geom_col(data=dataGER, aes(x = Date, y = incident_cases, color="Incident Cases"), alpha=0.5)+
...
>>>>>>> add1f7e3954b21954355d273a98c210168583bec
  xlim(c(as.Date('2020-02-15 00:00:00', format = "%Y-%m-%d %H:%M:%S"),
         as.Date('2020-05-20 00:00:00', format = "%Y-%m-%d %H:%M:%S")))+
